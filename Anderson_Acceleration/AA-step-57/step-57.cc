...
namespace Step57
{
  ...
  private:
    ...
    std::vector<int> row_index_set;
    std::vector<int> col_index_set;
...
/*
    ...
    const int &m)
  {
    ...
    F.extract_submatrix_from(F_temp,row_index_set,col_index_set);
    u_tilde.extract_submatrix_from(u_tilde_temp,row_index_set,col_index_set);
